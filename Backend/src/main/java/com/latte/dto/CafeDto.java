...
public class CafeDto {
	...
	public CafeDto(int cafe_id, String cafe_name, String cafe_address, String cafe_phone, double latitude,
			double longitude, String mon_open, String mon_close, String tue_open, String tue_close, String wed_open,
	...
	public String toString() {
		return "CafeDto [cafe_id=" + cafe_id + ", cafe_name=" + cafe_name + ", cafe_address=" + cafe_address
				+ ", cafe_phone=" + cafe_phone + ", latitude=" + latitude + ", longitude=" + longitude + ", mon_open="
				+ mon_open + ", mon_close=" + mon_close + ", tue_open=" + tue_open + ", tue_close=" + tue_close
				+ ", wed_open=" + wed_open + ", wed_close=" + wed_close + ", thu_open=" + thu_open + ", thu_close="
				+ thu_close + ", fri_open=" + fri_open + ", fri_close=" + fri_close + ", sat_open=" + sat_open
				+ ", sat_close=" + sat_close + ", sun_open=" + sun_open + ", sun_close=" + sun_close + ", closed="
				+ closed + "]";
	}
